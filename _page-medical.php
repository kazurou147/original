    ...
    <div class="l-page__content-outer p-medical" id="medical">
      ...
      <article <?php post_class(); ?>>
        ...
        <section class="p-medical-sec06" id="medical06">
          ...
          <div class="l-container-small">
            ...
            <div class="p-medical-sec06-block01">
              ...
              <a class="p-medical-sec06-block01__item" href="https://line.me/R/ti/p/@377vsvoo" target="_blank">
        ...
        <section class="p-medical-sec09" id="medical09">
          ...
          <div class="l-container-small">
            ...
            <div class="p-block01 u-mb110">
              ...
              <div class="p-block01__content">
                <p>
                  動物病院における二次診療や紹介とは、一次診療では対応が難しい専門的な治療や検査が必要な場合に、他の専門医や施設に紹介することを指します。当院では、ご紹介をいただいた際に、動物たちの健康状態や症状に基づき、最適な診療を受けられるよう尽力致しております。ぜひお気軽にご相談ください。
                </p>
              </div>
            </div>
        ...
        <section class="p-medical-sec10" id="medical10">
          ...
          <div class="l-container-small">
            <div class="c-subpage-heading u-mb80">
              <h2 class="c-subpage-heading__textBig">対象動物・当院から他院への紹介について</h2>
              <p class="c-subpage-heading__textSmall">TARGET ANIMAL</p>
            </div>

            <p class="u-text-center">当院は、犬・猫専門の獣医科病院です。犬・猫以外の動物は、当院で診療ができないため、他院を紹介いたしており、<br>
