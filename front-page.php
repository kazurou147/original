    ...
    <article <?php post_class(); ?>>
      ...
      <div class="p-front">
        ...
        <section class="p-front-mv">
          ...
          <div class="p-front-mv__inner">
            ...
            <div class="p-front-mv-banner-wrap">
              <div class="p-front-mv-banner u-tb-none wow fadeInUp">
                <p><img src='<?php echo esc_url(get_template_directory_uri()); ?>/img/front/mv-banner01.webp' alt=''
                    width="444"></p>
              </div>

              <figure class="p-front-mv-time u-tb-none wow fadeInUp">
                <img src='<?php echo esc_url(get_template_directory_uri()); ?>/img/front/mv-time.webp' alt=''
                  width="363">
              </figure>
        ...
        <ul class="p-common-list">
            ...
            <a href="/medical">
              <div class="menu-item-img">
                <img class="menu-icon-home"
                  src="<?php echo esc_url(get_template_directory_uri()); ?>/img/front/icon-pet.png" alt="診療案内"
                  width="42">
              </div>
          ...
          <li class="menu-item">
            <a href="/price-list">
              <div class="menu-item-img">
                <img class="menu-icon-home"
                  src="<?php echo esc_url(get_template_directory_uri()); ?>/img/front/icon-yen.png" alt="料金表"
                  width="37">
              </div>
      ...
      <section class="p-front-medical">
        ...
        <div class="l-container-small">
          ...
          <div class="p-front-medical-block01">
            <div class="p-front-medical-block01__item wow fadeInUp">
              <a href="<?php echo esc_url(home_url('/medical')); ?>">
                ...
                <figure class="p-front-medical-block01__img alt-img01">
            ...
            <div class="p-front-medical-block01__item wow fadeInUp" data-wow-delay="0.5s">
              <a href="<?php echo esc_url(home_url('/s-treatment')); ?>">
                ...
                <figure class="p-front-medical-block01__img alt-img02">
          ...
          <div class="p-front-medical-block02">
            <div class="p-front-medical-block02__item wow fadeInUp">
            ...
            <div class="p-front-medical-block02__item wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="p-front-medical-block02__item wow fadeInUp" data-wow-delay="0.6s">
      ...
      <section class="p-front-feature">
        ...
        <div class="l-container">
          ...
          <div class="p-front-feature-block01">
            ...
            <div class="p-front-feature-block01__item">
              <div class="p-front-feature-block01__img wow fadeInLeft">
              ...
              <div class="p-front-feature-block01__content wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="p-front-feature-block01__item p-front-feature-block01__item--rev">
              <div class="p-front-feature-block01__img wow fadeInRight">
              ...
              <div class="p-front-feature-block01__content p-front-feature-block01__content--rev wow fadeInUp"
                data-wow-delay="0.3s">
                <div class="p-front-feature-block01__content-inner">
            ...
            <div class="p-front-feature-block01__item">
              ...
              <div class="p-front-feature-block01__content wow fadeInUp" data-wow-delay="0.3s">
                <div class="p-front-feature-block01__content-inner">
                  ...
                  <div class="p-front-feature-block01__text">
                    <p>
                      当院では、ペットが突然の体調不良や事故に見舞われた際や、急な症状や不安な状況でも、当院の獣医師とスタッフが迅速に対応し、適切な治療を行うため、いつでもご安心ください。
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="p-front-feature-block01__item">
              <div class="p-front-feature-block01__img wow fadeInLeft">
                ...
                <div class="p-front-feature-block01__img-inner">
                  <img src='<?php echo esc_url(get_template_directory_uri()); ?>/img/front/feature-img05.webp' alt=''
                    width="500">
                </div>
              </div>
              <div class="p-front-feature-block01__content wow fadeInUp" data-wow-delay="0.3s">
                <div class="p-front-feature-block01__content-inner">
                  <h3 class="p-front-feature-block01__title">セカンドオピニオンも<br>行います。</h3>
                  <div class="p-front-feature-block01__text">
                    <p>
                      当院では、セカンドオピニオンに対応しております。ペットの治療方針について、より多くの情報を得たい場合や、別の視点からの診断を希望される飼い主様に対し、当院の獣医師が丁寧にご相談に応じます。<br>現在の治療内容に疑問や不安がある場合でも、私たちはペットの健康と飼い主様の安心を最優先に、適切なアドバイスをご提供致します。他院の診断結果をもとに、より良い治療方法を一緒に検討いたしますので、ぜひお気軽にご相談ください。
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section class="p-front-greeting">
        ...
        <div class="l-container">
          ...
          <div class="p-front-greeting-block01 wow fadeInUp">
      ...
      <section class="p-front-care">
        <div class="l-container-small">
          ...
          <div class="p-front-care-block01 u-mb40 wow fadeInUp">
